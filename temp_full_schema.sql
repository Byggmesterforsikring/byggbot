...
CREATE TABLE "Selskap" (
    ...
    "updated_at" TIMESTAMP(3) NOT NULL,
    "organisasjonsformBeskrivelse" TEXT,
    "forretningsKommune" TEXT,
    "forretningsKommunenummer" VARCHAR(4),
    "stiftelsesdato" TIMESTAMP(3),
...
CREATE TABLE "GarantiSakInterneKommentarer" (
    ...
    "opprettet_dato" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "dashboard_stats" (
    ...
    "private_customers" INTEGER,
    "business_customers" INTEGER,
    "total_premium" INTEGER,
    "private_premium" INTEGER,
    "business_premium" INTEGER,
    "claims_reported_ytd" INTEGER,
...
CREATE TABLE "claim_categories" (
    "id" SERIAL NOT NULL,
    "dashboard_stats_id" INTEGER NOT NULL,
...
-- CreateIndex
CREATE INDEX "system_prompts_prompt_type_is_active_updated_at_idx" ON "system_prompts"("prompt_type", "is_active", "updated_at");
...
-- AddForeignKey
ALTER TABLE "system_prompts" ADD CONSTRAINT "system_prompts_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "Users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "claim_categories" ADD CONSTRAINT "claim_categories_dashboard_stats_id_fkey" FOREIGN KEY ("dashboard_stats_id") REFERENCES "dashboard_stats"("id") ON DELETE CASCADE ON UPDATE CASCADE;
