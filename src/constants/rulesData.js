...
## 5. Endringer og fornyelse av avtale
...
* Standard fornyelsesmail lagres i Wims
* Bestillinger, endringsmeldinger eller oppsigelser lagres i Wims

## 7. Segment – hva skal ikke tegnes
* Rørleggervirksomhet eller andre bransjer enn hva som fremkommer under «Begrensninger» eller forespørsler der skadestatistikk viser gjentatte skader under ansvarsproduktet

## 8. Tariffering og rabatt
* Omsetning over 150 millioner MÅ tarifferes manuelt
* BMF sine tariffer i Wims skal benyttes
* Prispåslag til kunder som ikke er medlemmer i organisasjoner nevnt i punkt 2
...
* Sprøytemaling utvendig, egenandel minimum 10% av skadebeløp maks kr 150.000,-`,
  ...
  {
    id: 'ansvarsforsiking-prosjektering',
    title: 'Ansvarsforsikring for prosjektering',
    content: `Tegningsreglene gjelder Ansvarsforsikring ingeniør/arkitekt
...
## 2. Definisjon av kunde
* Produktet tilbys kun til virksomhet som har kundeforhold til BMF. Utgangspunktet skal være totalkundeforhold
...
## 4. Egenandel
* Egenandel er kr 40 000 dersom ikke annet avtales spesielt

## 5. Dekning
* Forsikringen dekker sikredes erstatningsansvar for økonomisk tap som skyldes ting- eller personskader som er voldt under utøvelse av virksomhet beskrevet i beviset
* Forsikringen gjelder for prosjekter der forsikringstaker kun har prosjektering som arbeidsområde/kontrakt i tiltaksklasse 1
* Forsikringen vil ikke gjelde når sikrede er utførene i tillegg eller har annen økonomisk interesse i prosjektet - se punkt 5. Begrensninger i vilkåret
* Tilleggsdekning for skader som konstateres senest 2 år etter virksomhetens opphør kan tegnes, men gjelder ikke ved opphør som følge av salg, virksomhetsoverdragelse og konkurs

## 6. Dokumentasjon
* Informasjon innhentet ved nysalg lagres i Wims
* Navneliste over ansatte som skal utføre tjenesten må innhentes
* Standard fornyelsesmail lagres i Wims
* Bestillinger, endringsmeldinger eller oppsigelser lagres i Wims

## 7. Tariffering
Inntil videre brukes manuell tariff etter følgende omsetning:
* Kr 500.000: kr 5.000,-
* Kr 1 million: kr 8.000,-
* Kr 2 millioner: kr 14.000,-
* Kr 3 millioner: kr 19.000,-
* Kr 4 millioner: kr 25.000,-
* Kr 5 millioner: kr 30.000,-

## 8. Intern prosjektering
Ansvar for intern prosjektering må begrenses til forsikringssum kr. 2 millioner. Dekningen må, der den skal tilbys, tekstes særskilt i forsikringsbeviset med følgende ordlyd:

Forsikringen er utvidet til å omfatte ansvar for internprosjektering foretatt av ansvarlig prosjekterende med formell ingeniørkompetanse.

Forsikringen dekker tap oppstått som følge av feil i skriftlig prosjektmateriell/prosjekttegninger

**Forsikringssum:** kr. 2.000.000 (eller mindre)  
**Egenandel:** kr. 100.000

**Forsikringen dekker ikke:**
* Tap oppstått som følge av muntlige tilvisninger eller råd
* Tap som har oppstått ved forsinkelse

Alle avtaler/tilbud skal vurderes og godkjennes av Underwriter.`,
    lastUpdated: '2024-10-10'
  },
  {
    id: 'arbeidsmaskin',
    title: 'Arbeidsmaskin',
    content: 'Innhold kommer her...',
